...
void output::write_status_header(ostream& os, model_ptr m)
{
    ...
    if (iter != type_aliases.end()) {
        ...
        write_status_class_decl(os, m);
        os << endl;

        // Inline functions
        write_status_class_global_ops(os, m);
        os << endl;

        write_status_class_global_debug_decl(os, m);
        os << endl;
    }
...
void output::write_status_source(ostream& os, model_ptr m)
{
    write_file_header(os);
    ...
    write_status_class_ctor(os, m);
    os << endl;

    write_status_class_ctor_copy(os, m);
    os << endl;

    write_status_class_ctor_value(os, m);
    os << endl;

    write_status_class_dtor(os, m);
    os << endl;

    write_status_class_assign(os, m);
    os << endl;

    write_status_class_valid(os, m);
    os << endl;

    write_status_class_value(os, m);
    os << endl;

    write_status_class_to_string(os, m);
    os << endl;

    write_status_class_to_variant(os, m);
    os << endl;

    write_status_class_from_string(os, m);
    os << endl;

    write_status_class_from_variant(os, m);
    os << endl;

    write_status_class_global_debug(os, m);
    os << endl;
...
void output::write_status_class_decl(ostream& os, model_ptr m)
{
    ...
    BOOST_FOREACH(field_ptr f, m->fields)
    {
        ...
        os << indent << indent << field_enum_name(f) << " = " << f->value;
    }
    os << endl
       << indent << "};" << endl;
    os << endl;
...
void output::write_status_class_ctor(ostream& os, model_ptr m)
{
...
void output::write_status_class_ctor_copy(ostream& os, model_ptr m)
{
...
void output::write_status_class_ctor_value(ostream& os, model_ptr m)
{
...
void output::write_status_class_dtor(ostream& os, model_ptr m)
{
    os << class_name_ << "::~" << class_name_ << "()" << endl;
    os << "{" << endl
       << "}" << endl;
...
void output::write_status_class_assign(ostream& os, model_ptr m)
{
...
void output::write_status_class_valid(ostream& os, model_ptr m)
{
...
void output::write_status_class_value(ostream& os, model_ptr m)
{
...
void output::write_status_class_to_string(ostream& os, model_ptr m)
{
    os << "QString " << class_name_ << "::toString() const" << endl
       << "{" << endl;
    os << indent << "return QString(QChar(m_value));" << endl;
    os << "}" << endl;
}

void output::write_status_class_to_variant(ostream& os, model_ptr m)
{
    os << "QVariant " << class_name_ << "::toVariant() const" << endl
       << "{" << endl;
    os << indent << "return QVariant(QChar(m_value));" << endl;
    os << "}" << endl;
}

void output::write_status_class_from_string(ostream& os, model_ptr m)
{
    ...
    os << indent << "int value = string.at(0).toLatin1();" << endl
       << indent << "if (";
    bool first = true;
    BOOST_FOREACH(field_ptr f, m->fields) {
        if (first)
            ...
            os << " || ";
        os << "value == " << field_enum_name(f);
    }
    os << ") {" << endl
       << indent << indent << "return " << class_name_ << "(value);" << endl
       << indent << "}" << endl;

    os << endl
       << indent << "return " << class_name_ << "();" << endl;

    os << "}" << endl;
}

void output::write_status_class_from_variant(ostream& os, model_ptr m)
{
...
void output::write_status_class_global_ops(std::ostream& os, model_ptr m)
{
...
void output::write_status_class_global_debug_decl(ostream& os, model_ptr m)
{
    os << decl_ << "QDebug operator<<(QDebug, const " << class_name_ << "& rhs);" << endl;
}

void output::write_status_class_global_debug(ostream& os, model_ptr m)
{
    os << "QDebug operator<<(QDebug dbg, const " << class_name_ << "& rhs)" << endl
       << "{" << endl;
    os << indent << "dbg.nospace() << '[' << rhs.value() << ']';" << endl;
