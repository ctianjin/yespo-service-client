#ifndef QPID_TRANSLATORMAINWINDOW_H
#define QPID_TRANSLATORMAINWINDOW_H
...
class Ui_TranslatorMainWindow;
struct TranslatorMainWindowOptions;
class TranslatorInfo;

class TranslatorMainWindow : public MainWindow, public PreferenceSupport
{
    Q_OBJECT
...
public:
    explicit TranslatorMainWindow(QWidget* parent = 0);
    virtual ~TranslatorMainWindow();
...
private:
    ...
    QScopedPointer<Ui_TranslatorMainWindow> m_ui;
    QScopedPointer<TranslatorMainWindowOptions> m_opt;
...
/*	LoginDialog* m_l;*/
	...
	TranslatorInfo* m_callInfo;
// 	CallSplash* m_callSplash;
// 	QTimer* m_clockTimer;
// 	QTimer* m_durationTimer;

    Q_DISABLE_COPY(TranslatorMainWindow)
};

} // namespace Qpid

#endif // QPID_TRANSLATORMAINWINDOW_H
